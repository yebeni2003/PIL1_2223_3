"""
URL configuration for PIL_3 project.
...
urlpatterns = [
    ...
    path('reset_password_send',views.PasswordResetDoneView.as_view(template_name='password_reset.sent.html'),name='password_reset_done'),
